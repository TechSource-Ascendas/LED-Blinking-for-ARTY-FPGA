...
% 4 LEDs only: the dedicated green LD4..LD7 (no RGB LEDs). Distinct from
% the MathWorks-shipped XilinxArty board's built-in 4-wide "LEDs General
% Purpose" interface, which wrongly constrains these same pins to
% LVCMOS15 and causes a Bank IO standard Vcc DRC conflict with clk
% (LVCMOS33) in bank 35 during place_design.
hB.addExternalIOInterface( ...
    'InterfaceID',    'LEDs General Purpose (4 LED)', ...
    'InterfaceType',  'OUT', ...
    'PortName',       'GPLEDs4', ...
    'PortWidth',      4, ...
    'FPGAPin',        {'H5','J5','T9','T10'}, ...
    'IOPadConstraint', {'IOSTANDARD = LVCMOS33'});
